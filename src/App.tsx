    ...
    <div className="relative min-h-screen bg-[#05050A] text-[#F4F6FA] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 lg:px-12 py-6 flex items-center justify-between bg-gradient-to-b from-[#05050A] to-transparent" aria-label="Main navigation">
        <div className="flex items-center gap-3">
          <img src="/logo.png" alt="AgenticFlow Logo - AI Business Automation" width="40" height="40" loading="eager" className="w-10 h-10" />
          <span className="text-xl font-semibold tracking-tight">AgenticFlow</span>
        </div>
        <div className="hidden md:flex items-center gap-8">
          <a href="#work" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Work</a>
          <a href="#services" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Services</a>
          <a href="#pricing" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Pricing</a>
          <a href="#contact" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Contact</a>
        </div>
        <Button 
      ...
      >
        <a id="main-content" className="sr-only">Main content starts here</a>
        {/* Background Image */}
        <div 
        ...
        <div className="relative z-10 w-full px-6 lg:px-16 pt-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-[1600px] mx-auto">
            ...
            <div className={`space-y-8 transition-all duration-1000 ${isVisible('hero') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[0.95] tracking-tight" itemProp="headline">
                Your business runs<br />
                while you<br />
                <span className="text-[#39FF14] relative">
                  sleep
                  <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#39FF14] opacity-60" />
                </span>.
              </h1>
              <p className="text-lg text-[#A7ACB8] max-w-xl leading-relaxed" itemProp="description">
              ...
              <div className="flex flex-wrap gap-4">
                <Button 
                  ...
                  onClick={() => trackButtonClick('book_audit')}
                >
                ...
                <Button 
                  ...
                  onClick={() => trackButtonClick('see_builds')}
                >
                  See recent builds
                </Button>
              </div>
      ...
      >
            ...
            >
              <div className="card-dark p-8 lg:p-10 space-y-6">
                ...
                <div className="flex items-center justify-center gap-2 text-sm text-[#A7ACB8] pt-4">
                  ...
                  <a href="mailto:contact@agenticflow.me" className="text-[#39FF14] hover:underline">
        ...
        {/* Footer */}
        <footer className="w-full px-6 lg:px-16 mt-24 pt-12 border-t border-[#F4F6FA]/10" role="contentinfo">
          <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8">
              <a href="#" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Privacy</a>
              <a href="#" className="text-sm text-[#A7ACB8] hover:text-[#39FF14] transition-colors">Terms</a>
