    ...
    <div className="pt-24" itemScope itemType="https://schema.org/BlogPosting">
      <article className="py-24 px-6 lg:px-16">
        <div className="max-w-[800px] mx-auto">
          {/* Back */}
          <Link href="/blog" className="flex items-center gap-2 text-[#A7ACB8] hover:text-[#39FF14] text-sm mb-8 transition-colors">
          ...
          <div className="flex justify-between items-center mt-12 pt-8 border-t border-[#F4F6FA]/10 gap-4">
            {prevPost ? (
              <Link href={`/blog/${prevPost.slug}`} className="flex items-center gap-2 text-[#A7ACB8] hover:text-[#39FF14] text-sm transition-colors">
                <ArrowLeft className="w-4 h-4" /> {prevPost.title.slice(0, 40)}...
              </Link>
            ) : <span />}
            {nextPost ? (
              <Link href={`/blog/${nextPost.slug}`} className="flex items-center gap-2 text-[#A7ACB8] hover:text-[#39FF14] text-sm transition-colors text-right">
