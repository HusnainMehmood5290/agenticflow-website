...
export const metadata: Metadata = {
  title: 'AI Agent Integration - GPT-4, Claude & Gemini Workflows',
  description: 'We embed AI models — GPT-4, Claude, Gemini — directly into your business workflows. Intelligent agents that reason, decide, and act autonomously in your n8n automations.',
  alternates: { canonical: '/services/ai-agent-integration' },
};
