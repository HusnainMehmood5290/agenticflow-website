...
export const metadata: Metadata = {
  title: '24/7 Monitoring & Maintenance - Workflow Reliability',
  description: 'Round-the-clock monitoring, alerting, and maintenance for your automation infrastructure. We detect and resolve issues before they impact your business.',
  alternates: { canonical: '/services/monitoring-maintenance' },
};
