...
export const metadata: Metadata = {
  title: 'n8n Workflow Development - Custom Automation Workflows',
  description: 'Custom-built n8n workflows designed, developed, and deployed for your business. From simple automations to complex multi-step AI pipelines — production-grade workflows that run 24/7.',
  alternates: { canonical: '/services/n8n-workflow-automation' },
};
